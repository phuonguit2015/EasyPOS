...
namespace EasyPOS.BLL
{
    class DonViBLL
    {
        ...
        {
            IEnumerable<DONVI> query = from dv in dbContext.DONVIs select dv;
            return query;
        }
        ...
        {
            IEnumerable<DONVI> query = from dv in dbContext.DONVIs where dv.TenDonVi == _tenDonVi select dv;
        ...
        {
            IEnumerable<DONVI> query = from dv in dbContext.DONVIs where dv.MaDonVi == iddv select dv;
